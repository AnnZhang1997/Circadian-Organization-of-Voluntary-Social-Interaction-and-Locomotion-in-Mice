...
Removal = struct(); 
Solitary = struct(); 
%%  --- animal age (in month) at experiment onset ---
    Solitary.s1.Age = 8;
    Solitary.s2.Age = 8;
    Solitary.s3.Age = 8;
    Solitary.s4.Age = 8;

    Paired.p1l.Age = 8; Paired.p1r.Age = 8; Removal.r1.Age = 8;
    Paired.p2l.Age = 5; Paired.p2r.Age = 5; Removal.r2.Age = 5;
    Paired.p3l.Age = 6; Paired.p3r.Age = 6; Removal.r3.Age = 6;
    Paired.p4l.Age = 6; Paired.p4r.Age = 6; Removal.r4.Age = 6;
%%  --- Solitary Animal's Daily Data (n=4) ---
    Solitary.s1.entries_day = [12, 14, 17, 19, 36, 27, 20];
    Solitary.s1.entries_night = [68, 67, 98, 91, 75, 55, 49];
    ...
    Solitary.s2.entries_day = [20 13 24 12 14 22 27];
    Solitary.s2.entries_night = [63 43 48 78 45 37 54];
    ...
    Solitary.s3.entries_day = [21 25 17 21 17 20 25];
    Solitary.s3.entries_night = [63 43 42 54 50 60 66];
    ...
    Solitary.s4.entries_day = [24, 23, 16, 19, 17, 16, 18];
    Solitary.s4.entries_night = [27, 25, 26, 29, 18, 37, 21]+10;
...
%%  --- Paired Animal's Daily Data (n=8 animals, 4 pairs) ---
    Paired.p1l.entries_day = [27, 33, 28, 30, 24, 23, 22];
    Paired.p1l.entries_night = [112, 119, 104, 113, 82, 65, 42];
    ...
    Paired.p1r.entries_day = [19, 14, 16, 12, 14, 11, 7];
    Paired.p1r.entries_night = [37, 44, 46, 59, 57, 36, 40];
    ...
    Paired.p2l.entries_day = [20, 18, 13, 42, 34, 24, 13];
    Paired.p2l.entries_night = [62, 102, 61, 77, 128, 41, 64];
    ...
    Paired.p2r.entries_day = [13, 27, 9, 10, 20, 24, 22];
    Paired.p2r.entries_night = [71, 51, 43, 78, 55, 56, 31];
    ...
    Paired.p3l.entries_day = [109, 71, 66, 65, 70, 40, 56];
    Paired.p3l.entries_night = [139, 151, 149, 86, 107, 76, 103];
    ...
    Paired.p3r.entries_day = [20, 11, 18, 26, 11, 8, 21];
    Paired.p3r.entries_night = [49, 42, 29, 35, 28, 28, 56];
    ...
    Paired.p4l.entries_day = [22 12 8 7 8 5 6];
    Paired.p4l.entries_night = [50, 52, 70, 77, 85, 74, 70];
    ...
    Paired.p4r.entries_day = [54, 21, 28, 32, 25, 22, 18];
    Paired.p4r.entries_night = [131, 138, 71, 68, 53, 63, 67];
    ...
    Interaction.p1.entries_day = [10, 12, 14, 13, 8, 4, 5];
    Interaction.p1.entries_night = [23, 42, 30, 43, 31, 21, 18];
    Interaction.p1.duration_day = [516, 811, 1108, 1468, 788, 417, 482];
    Interaction.p1.duration_night = [842, 2200, 2122, 2645, 1538, 821, 1727];
    
    Interaction.p2.entries_day = [2, 2, 1, 8, 5, 2, 6];
    Interaction.p2.entries_night = [31, 12, 13, 16, 27, 26, 15];
    Interaction.p2.duration_day = [51, 25, 14, 225, 140, 110, 149];
    Interaction.p2.duration_night = [1898, 328, 217, 181, 1072, 1374, 752];
    
    Interaction.p3.entries_day = [14, 6, 12, 14, 5, 8, 12];
    Interaction.p3.entries_night = [24, 31, 19, 19, 14, 21, 42];
    Interaction.p3.duration_day = [292, 62, 397, 445, 120, 403, 398];
    Interaction.p3.duration_night = [518, 869, 513, 567, 454, 633, 1248];
    
    Interaction.p4.entries_day = [11, 0, 0, 1, 2, 2, 0];
    Interaction.p4.entries_night = [37, 21, 29, 20, 45, 49, 50];
...
%%  --- Partner-Removed Animal's Daily Data (n=4) ---
    Removal.r1.entries_day = [13, 16, 14, 13, 10, 19, 14];
    Removal.r1.entries_night = [29, 23, 46, 38, 47, 27, 26];
    ...
    Removal.r2.entries_day = [22, 18, 8, 9, 10, 7, 8];
    Removal.r2.entries_night = [62, 40, 30, 38, 24, 16, 34];
    ...
    Removal.r3.entries_day = [20, 16, 23, 21, 15, 13, 14];
    Removal.r3.entries_night = [34, 25, 39, 45, 20, 27, 34];
    ...
    Removal.r4.entries_day = [34, 27, 21, 53, 51, 49, 38];
    Removal.r4.entries_night = [75, 31, 52, 51, 92, 79, 83];
...
%% Age (months) at experiment onset
    Solitary.s1.Age = 10;
    Solitary.s2.Age = 10;
    Solitary.s3.Age = 4;
    Solitary.s4.Age = 4;

    Paired.p1l.Age = 9; Paired.p1r.Age = 9; Removal.r1.Age = 9;
    Paired.p2l.Age = 10; Paired.p2r.Age = 10; Removal.r2.Age = 10;
    Paired.p3l.Age = 4; Paired.p3r.Age = 4; Removal.r3.Age = 4;
    Paired.p4l.Age = 4; Paired.p4r.Age = 4; Removal.r4.Age = 4;
...
%   Interaction Data
    ...
    Interaction.p1.entries = [24, 37, 28, 31, 17, 20, 17];
    ...
    Interaction.p2.entries = [43, 52, 43, 44, 27, 29, 37];
    ...
    Interaction.p3.entries = [88, 70, 58, 74, 62, 40, 37];
...
%% Attach Quantified Social Activity file names
    Paired      = addFileNames(Paired, true, 'DD');
    Interaction = addFileNames(Interaction, false, 'DD');
    Removal     = addFileNames(Removal, true, 'DD');
    Solitary    = addFileNames(Solitary, true, 'DD');

%% Attach Locomotor .AWD file names
    Solitary.s1.file_awd = "Data/DD_Locomotor/Solitary1.awd";
    Solitary.s2.file_awd = "Data/DD_Locomotor/Solitary2.awd";
    Solitary.s3.file_awd = "Data/DD_Locomotor/Solitary3.awd";
    Solitary.s4.file_awd = "Data/DD_Locomotor/Solitary4.awd";
    Paired.p1l.file_awd  = "Data/DD_Locomotor/Paired1Left.awd";
    Paired.p1r.file_awd  = "Data/DD_Locomotor/Paired1Right.awd";
    Paired.p2l.file_awd  = "Data/DD_Locomotor/Paired2Left.awd";
    Paired.p2r.file_awd  = "Data/DD_Locomotor/Paired2Right.awd";
    Paired.p3l.file_awd  = "Data/DD_Locomotor/Paired3Left.awd";
    Paired.p3r.file_awd  = "Data/DD_Locomotor/Paired3Right.awd";
    Paired.p4l.file_awd  = "Data/DD_Locomotor/Paired4Left.awd";
    Paired.p4r.file_awd  = "Data/DD_Locomotor/Paired4Right.awd";
    Removal.r1.file_awd  = "Data/DD_Locomotor/Removal1.awd";
    Removal.r2.file_awd  = "Data/DD_Locomotor/Removal2.awd";
    Removal.r3.file_awd  = "Data/DD_Locomotor/Removal3.awd";
    Removal.r4.file_awd  = "Data/DD_Locomotor/Removal4.awd";
...
%   locomotor_daily
    ...
    pairs = {
        'entries',         'entries_day',         'entries_night'
